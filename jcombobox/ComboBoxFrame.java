...
public class ComboBoxFrame extends JFrame {
    ...
    public ComboBoxFrame() {
        ...
        imagesJComboBox.addItemListener(
                new ItemListener() // classe interna anônima - classe que é declarada sem o nome e que aparece dentro de um método. Uma classe interna anônima declarada em um método pode acessar as var de instância e métodos do obj de classe de primeiro nível, bem como as var locais do método.
        {
