...
public class CreditInquiry {
    ...
    private static MenuOption getRequest() {
        ...
        return choices[request - 1]; // retorna um valor enum
    }
    ...
    private static void readRecords(MenuOption accountType) {
        ...
        try (Scanner input = new Scanner(Paths.get("/media/anonymous/46f8a10f-f298-4201-8ff1-296f11356171/backup/projetos/codes/java/codes-for-study/TextFileApps/clients.txt"))) {
            while (input.hasNext()) {
    ...
    // determina se o registro atual satisfaz o tipo de conta solicitada
