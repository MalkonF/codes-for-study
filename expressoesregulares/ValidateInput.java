...
public class ValidateInput {
    ...
    /*Essa expressão vai ver se localiza o padrão na string contida em firstName. Se encontrar
        ...
        \d corresponde sempre a um digito na string buscada*/
    public static boolean validateFirstName(String firstName) {
        return firstName.matches("[A-Z][a-zA-Z]*");//aqui o * tá dizendo, depois da primeira letra maiuscula
        //tudo que vier depois tem que bater com essa expressão
    }
...
+ - tenta identificar uma ou mais ocorrências da subexpressao anterior a +.
