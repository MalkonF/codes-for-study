...
public class KeyDemoFrame extends JFrame implements KeyListener {
    ...
    public void keyPressed(KeyEvent event) {
        ...
        /* getKeyCode retorna o código da tecla e getKeyText o nome da tecla de acordo com o código*/
        setLines2and3(event);
    }
    ...
    private void setLines2and3(KeyEvent event) {
        ...
        String temp = KeyEvent.getKeyModifiersText(event.getModifiers());/*verifica se foi pressionada alguma 
        tecla modificadora(alt, shift e ctrl)*/
