...
/*Todas as classes de exceção herdam direta ou indiretamente da classe Exception, formando um hierarquia de
herança. Qnd se faz uma classe para lançar exceção tem que se estender essa classe ou alguma subclasse*/
