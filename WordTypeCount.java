...
public class WordTypeCount {
    ...
    public static void main(String[] args) {
        // Cria hashmap para guardar chave tipo String e valores tipo Integer com 16 elementos e um fator de carga 0,75.Qnd o núm d slots ocupados no HashMap torna-se maior do q a capacidade multiplicada pelo fator carga, a capacidade é dobrada automaticamente.
    ...
    private static void createMap(Map<String, Integer> map) {
        ...
        for (String token : tokens) {
            ...
            if (map.containsKey(word)) {//verifica se a palavra está no mapa
                ...
                map.put(word, 1); // cria uma nova entada com a palavra como a chave e um obj Integer contendo 1 como valor(aqui ocorre um autoboxing com 1 p Integer)
            }
        }
    }
