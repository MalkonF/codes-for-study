...
public class MetricsJPanel extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        FontMetrics metrics = g.getFontMetrics();//obtém obj FontMetrics p fonte atual
...
/*descendente - qt um caractere desce abaixo da linha de base
ascendente - qt um caractere se eleva acim ada linha de base
entrelinha - a diferença entre a ascendente de uma linha de txt e a descendente da linha de txt embaixo dela - isto é o espaçamento entre linhas.*/
