/*Código retirado do livro: Java - Como programar - Paul Deitel/ Harvey Deitel*/
 /*
O método que pode lançar uma exceção deve especificar o tipo com throws. Na chamada do método que pode lançar a exceção deve estar em volto num bloco try. Se tiver um catch correspondente a exceção especificada no corpo do método o programa consegue capturar ela.

Relançar uma exceção adia o tratamento de exceção para outro bloco catch associado com uma instrução try mais externa*/
