...
/*Java 2d API fornece capacidade gráficas bidimensionais.
Graphics2D é uma subclasse abstrata da classe Graphics.
O objeto real utilizado p desenhar em cada método paintComponent é uma instância de uma subclasse de Graphics2D q é 
passada p o método paintComponent e acessada via superclasse Graphics. P acessar as capacidades de Graphics2D, 
devemos fzr a coerção da ref Graphics(g) passada a paintComponent p uma ref Graphics2D*/